 ...
 *   https://datatables.net/download/#bs4/dt-1.10.18/b-1.5.6/kt-2.5.0/r-2.2.2
 *
 * Included libraries:
 *   DataTables 1.10.18, Buttons 1.5.6, KeyTable 2.5.0, Responsive 2.2.2
 */
...
(function (h) {
  ...
  n.ext = x = { buttons: {}, classes: {}, build: 'bs4/dt-1.10.18/b-1.5.6/kt-2.5.0/r-2.2.2', errMode: 'alert', feature: [], search: [], selector: { cell: [], column: [], row: [] }, internal: {}, legacy: { ajax: null }, pager: {}, renderer: { pageButton: {}, header: {} }, order: {}, type: { detect: [], search: {}, order: {} }, _unique: 0, fnVersionCheck: n.fnVersionCheck, iApiIndex: 0, oJUIClasses: {}, sVersion: n.version };
...
(function (d) {
  ...
  d.extend(t.prototype, {
    ...
    _buildButton: function (a, b) {
      ...
      return { conf: a, node: m.get(0), inserter: e, buttons: [], inCollection: b, collection: null };
    },
  ...
  t.buttonSelector = function (a, b) {
    for (
      var c = [],
        e = function (a, b, c) {
          for (var d, f, g = 0, k = b.length; g < k; g++) if ((d = b[g])) (f = c !== l ? c + g : g + ''), a.push({ node: d.node, name: d.conf.name, idx: f }), d.buttons && e(a, d.buttons, f + '-');
        },
        f = function (a, b) {
          var g,
            h = [];
          ...
          if (d.isArray(a) || a instanceof d) for (k = 0, g = a.length; k < g; k++) f(a[k], b);
          else if (null === a || a === l || '*' === a) for (k = 0, g = h.length; k < g; k++) c.push({ inst: b, node: h[k].node });
          else if ('number' === typeof a) c.push({ inst: b, node: b.s.buttons[a].node });
          else if ('string' === typeof a)
            if (-1 !== a.indexOf(',')) for (h = a.split(','), k = 0, g = h.length; k < g; k++) f(d.trim(h[k]), b);
            else if (a.match(/^\d+(\-\d+)*$/))
              (k = d.map(h, function (a) {
                return a.idx;
              })),
                c.push({ inst: b, node: h[d.inArray(a, k)].node });
            else if (-1 !== a.indexOf(':name')) for (a = a.replace(':name', ''), k = 0, g = h.length; k < g; k++) h[k].name === a && c.push({ inst: b, node: h[k].node });
            else
              d(k)
                .filter(a)
                .each(function () {
  ...
  var x = function (a) {
    ...
    D = function (a, b) {
      ...
      a.select && 'function' === typeof a.select.info && g.selected === l && a.rows(c.rows, d.extend({ selected: !0 }, g)).any() && d.extend(g, { selected: !0 });
...
(function (c) {
  ...
  c.extend(!0, a.Buttons.defaults, {
    dom: { container: { className: 'dt-buttons btn-group' }, button: { className: 'btn btn-secondary' }, collection: { tag: 'div', className: 'dt-button-collection dropdown-menu', button: { tag: 'a', className: 'dt-button dropdown-item', active: 'active', disabled: 'disabled' } } },
...
(function (b) {
  ...
  b.extend(p.prototype, {
    ...
    _constructor: function () {
      ...
      if (this.c.editor) {
        ...
        if (this.c.editOnFocus)
          c.on('key-focus.keyTable key-refocus.keyTable', function (b, c, d, f) {
            a._editor(null, f, !0);
          });
      ...
      g.getSelection &&
        ...
        b(e).on('paste.keyTable', function (b) {
          ...
          var d = c.s.lastFocus,
            ...
            m = c.c.editor,
            h;
          !d || (f && 'body' !== f.nodeName.toLowerCase()) || (b.preventDefault(), g.clipboardData && g.clipboardData.getData ? (h = g.clipboardData.getData('Text')) : b.clipboardData && b.clipboardData.getData && (h = b.clipboardData.getData('text/plain')), m ? m.inline(d.cell.index()).set(m.displayed()[0], h).submit() : (d.cell.data(h), a.draw(!1)));
        }));
    },
    _columns: function () {
      var a = this.s.dt,
    ...
    _focus: function (a, c, d, k) {
      ...
      if (this.s.enable) {
        ...
        if (-1 !== h.length && (a < h.start || a >= h.start + h.length))
          ...
          this.s.lastFocus = { cell: h, node: h.node(), relative: { row: m.rows({ page: 'current' }).indexes().indexOf(h.index().row), column: h.index().column } };
          ...
          if (!this.c.keys || -1 !== b.inArray(a.keyCode, this.c.keys))
            switch (a.keyCode) {
              ...
              case 40:
                ...
                break;
              default:
                !0 === c && this._emitEvent('key', [k, a.keyCode, this.s.lastFocus.cell, a]);
            }
        }
      }
    },
    ...
    _shift: function (a, c, d) {
      var k = this.s.dt,
        ...
        e = this._columns();
      if (h) {
        var l = k.rows({ filter: 'applied', order: 'applied' }).indexes().indexOf(h.index().row);
  ...
  b(e).on('preInit.dt.dtk', function (a, c, d) {
    'dt' === a.namespace && ((a = c.oInit.keys), (d = l.defaults.keys), a || d) && ((d = b.extend({}, d, a)), !1 !== a && new p(c, d));
  });
  return p;
});
...
(function (d) {
  ...
  var o = d.fn.dataTable,
    i = function (a, b) {
      ...
      this.s.dt.settings()[0].responsive || (b && 'string' === typeof b.details ? (b.details = { type: b.details }) : b && !1 === b.details ? (b.details = { type: !1 }) : b && !0 === b.details && (b.details = { type: 'inline' }), (this.c = d.extend(!0, {}, i.defaults, o.defaults.responsive, b)), (a.responsive = this), this._constructor());
    };
